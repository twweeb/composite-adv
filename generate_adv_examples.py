...
def print_adv_examples(model, val_loader, args, given_data=None):
    ...
    orig_successful = np.ones(N, dtype=bool)
    ...
    for attack_index, attack_name in enumerate(attacks):
        ...
        if attack_name is None:
            ...
            unsuccessful = (orig_labels != labels).cpu().detach().numpy()\
                .astype(bool)
            orig_successful[unsuccessful] = False
        else:
...
if __name__ == '__main__':
    main()
>>>>>>> 46bada5510ef3c49371326f443b609ae9308ab2e
